...
export default function CreateNewNotes({ createNewNote, editNote, updateNote }) {
    ...
    return(
        ...
        onSubmit={handleSubmit}>
            ...
            <button disabled={day.length === 0 || title.length === 0 || description.length === 0} type="submit" className="mt-4 px-3 py-2 text-white font-semibold rounded-md disabled:cursor-not-allowed bg-yellow-400 hover:bg-yellow-500 disabled:opacity-70 disabled:hover:bg-yellow-500">Buat Catatan</button>
        </form>
    );
}
